...
class ListSearch extends Component {
    render() {
        return (
            ...
            {this.props.livros.books ?(this.props.livros.books.map((x)=>(
            <li key={x.id} >
              <div className="book">
                <div className="book-top">
                  ...
                  <div className="book-shelf-changer">
                    <select  defaultValue={ typeof(x.shelf) != "undefined" && x.shelf !== null ? x.shelf :'none'}  onChange={(e) => this.props.onUpdateBook(x,e.target.value)} >
          ...
          <li>Your search did not match any books.
          <span className="emotion">¯\_(ツ)_/¯</span></li>)}</ol>
          </div>
          )
    }
